...
/**
 * @ngdoc object
 * @name lbServices.Physician
 * @header lbServices.Physician
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Physician` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
         ...
         */
        "create": {
          url: urlBase + "/Physicians",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Physician#createMany
         * @methodOf lbServices.Physician
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Physician#upsert
         * @methodOf lbServices.Physician
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Physician#exists
         * @methodOf lbServices.Physician
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/Physicians/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Physician#findById
         * @methodOf lbServices.Physician
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/Physicians/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Physician#find
         * @methodOf lbServices.Physician
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Physician#findOne
         * @methodOf lbServices.Physician
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/Physicians/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Physician#updateAll
         * @methodOf lbServices.Physician
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/Physicians/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Physician#deleteById
         * @methodOf lbServices.Physician
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Physician#count
         * @methodOf lbServices.Physician
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/Physicians/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Physician#prototype$updateAttributes
         * @methodOf lbServices.Physician
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Physician#createChangeStream
         * @methodOf lbServices.Physician
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/Physicians/change-stream",
          method: "POST"
        },

        // INTERNAL. Use Appointment.physician() instead.
        "::get::Appointment::physician": {
          url: urlBase + "/Appointments/:id/physician",
          method: "GET"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Physician#updateOrCreate
         * @methodOf lbServices.Physician
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Physician#update
         * @methodOf lbServices.Physician
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Physician#destroyById
         * @methodOf lbServices.Physician
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Physician#removeById
         * @methodOf lbServices.Physician
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Physician#modelName
    * @propertyOf lbServices.Physician
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Physician`.
    */
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Appointment#countFutureAppointments
         * @methodOf lbServices.Appointment
         *
         * @description
         *
        ...
        "countFutureAppointments": {
          url: urlBase + "/Appointments/countFutureAppointments",
          method: "POST"
        },
      }
    );
    ...
    */
    R.modelName = "Appointment";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Appointment#physician
         * @methodOf lbServices.Appointment
         *
         * @description
         *
         ...
         * </em>
         */
        R.physician = function() {
          var TargetResource = $injector.get("Physician");
          var action = TargetResource["::get::Appointment::physician"];
